...
WITH list AS
(
    Select 'SRID=4326;GEOMETRYCOLLECTION(POINT(1 2))' as txt
    UNION ALL
    Select 'SRID=4326;GEOMETRYCOLLECTION(POINT(1 2 3))' as txt
    UNION ALL
    Select 'SRID=4326;GEOMETRYCOLLECTION(POINT(1 2 3))' as txt
    UNION ALL
    Select 'SRID=4326;GEOMETRYCOLLECTION(POINT(1 2 3))' as txt
...
SELECT 'gml_61', ST_AsEWKT(ST_GeomFromGML(ST_AsGML(3, ST_AsEWKT(txt), 16))) from list;
